            ...
            if is_last_cube:
                ...
                try:
                    ...
                    if plan is not None:
                        ...
                        carb.log_warn("Could not plan to intermediate position, trying home directly")
                except Exception as e:
                ...
                try:
                    ...
                    if plan is None:
                        carb.log_warn("Failed to plan to home position, continuing anyway")
                    else:
                        await self._execute_plan(plan)
                        for _ in range(10):
                            await omni.kit.app.get_app().next_update_async()
                ...
                try:
                    ...
                    if plan is not None:
                        ...
                        carb.log_warn("Could not plan to intermediate position")
                except Exception as e:
                    carb.log_warn(f"Error moving to intermediate position: {e}")
