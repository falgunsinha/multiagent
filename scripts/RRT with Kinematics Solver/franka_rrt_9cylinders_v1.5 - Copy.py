...
class FrankaRRTDynamicGrid:
        ...
        try:
            ...
            if camera_prim:
                ...
                if focal_length_attr:
                    focal_length_attr.Set(13.0)
                    print(f"[DEPTH CAMERA] Focal length set to 13.0mm")
                else:
            ...
            self.depth_camera.set_focal_length(13.0)  # 13mm focal length
            print(f"[DEPTH CAMERA] Focal length set via API to 13.0mm")
            ...
            self.depth_camera.set_focal_length(13.0)
            ...
            if camera_prim:
                ...
                if focal_length_attr:
                    ...
                    if current_focal != 13.0:
                        focal_length_attr.Set(13.0)
                        print(f"[DEPTH CAMERA] Focal length corrected to 13.0mm via USD API")
            ...
            print("[DEPTH CAMERA] Focal Length: 13.0mm")
    ...
    async def _pick_and_place_cube(self, cube, cube_name):
        ...
        try:
            ...
            # Cylinder half height = 0.07725/2 = 0.038625m
            ...
            # Small offset to prevent physics penetration (2mm clearance)
