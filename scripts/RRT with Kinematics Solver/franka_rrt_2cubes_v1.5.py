    ...
    async def _pick_and_place_cube(self, cube, cube_name):
        ...
        try:
            ...
            for pick_attempt in range(1, max_pick_attempts + 1):
                ...
                # Phase 2: Move directly above target at safe height (35cm)
                # This is the ONLY waypoint - simplifies motion and reduces rotations
                high_waypoint = np.array([cube_pos_current[0], cube_pos_current[1], 0.35])
                ...
                # Target cube center (not top) so gripper fingers straddle the middle
                ...
                retreat_pos = np.array([cube_pos_realtime[0], cube_pos_realtime[1], 0.35])
