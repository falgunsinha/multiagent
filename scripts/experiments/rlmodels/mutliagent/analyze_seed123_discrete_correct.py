"""
Analyze only seed 123 results for discrete models with CORRECT success rate calculation
Success rate = (total cubes picked) / (total episodes * num_cubes per episode)
"""
import pandas as pd
from pathlib import Path

csv_path = Path("two_agent_results/discrete/seed_123/episode_results.csv")
...
print("="*140)
print("DISCRETE ALGORITHMS - SEED 123 ONLY (CORRECT SUCCESS RATE CALCULATION)")
print("="*140)
