...
class MaSacAgent:
    ...
    def train(self, num_episode: int, max_iteration: int=1000, plotting_interval: int=400):
        ...
        torch.save(self.actor.state_dict(), "model_weight/mactor.pt")
        torch.save(self.qf1.state_dict(), "model_weight/mqf1.pt")
        torch.save(self.qf2.state_dict(), "model_weight/mqf2.pt")
        torch.save(self.vf.state_dict(), "model_weight/mvf.pt")
