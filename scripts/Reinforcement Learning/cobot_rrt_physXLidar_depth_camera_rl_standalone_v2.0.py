...
class FrankaRRTDynamicGrid:
            ...
            if hasattr(self, '_initial_obstacle_positions'):
                for obstacle_name, position in self._initial_obstacle_positions.items():
                    if obstacle_name in self.obstacles:
                        ...
                        print(f"[INIT] Set {obstacle_name} position to {position}")
    ...
    async def _reset_to_safe_config(self):
        ...
        for _ in range(20):  # 20 frames @ 60Hz = ~333ms stabilization
            await omni.kit.app.get_app().next_update_async()
    ...
    def _add_initial_obstacles(self):
        ...
        try:
            ...
            rigid_body_api_1.CreateKinematicEnabledAttr().Set(False)  # Dynamic rigid body
            ...
            rigid_body_api_2.CreateKinematicEnabledAttr().Set(False)  # Dynamic rigid body
