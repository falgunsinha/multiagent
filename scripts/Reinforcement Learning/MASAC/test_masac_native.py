"""
Test MASAC on RRT Viz and A* configurations (6 configs)
Uses native Python (not Isaac Sim)

Usage:
    python test_masac_native.py --episodes 5
"""
...
def main():
    ...
    # A* and RRT Viz configurations (A* first, then RRT Viz)
    configurations = [
        # A* (3 configs)
        ('astar', 3, 4),
        ('astar', 4, 6),
