@echo off
REM Train all 9 Double DQN configurations with updated timesteps
REM 3 methods x 3 configurations = 9 total experiments
REM Estimated total time: 3-5 hours (without W&B)

echo ============================================================
echo TRAINING ALL 9 DOUBLE DQN CONFIGURATIONS
echo ============================================================
...
py -3.11 train_astar_ddqn.py --grid_size 3 --num_cubes 4 --timesteps 50000
if %errorlevel% neq 0 (
...
py -3.11 train_astar_ddqn.py --grid_size 4 --num_cubes 6 --timesteps 50000
if %errorlevel% neq 0 (
...
py -3.11 train_astar_ddqn.py --grid_size 4 --num_cubes 9 --timesteps 50000
if %errorlevel% neq 0 (
...
py -3.11 train_rrt_viz_ddqn.py --grid_size 3 --num_cubes 4 --timesteps 50000
if %errorlevel% neq 0 (
...
py -3.11 train_rrt_viz_ddqn.py --grid_size 4 --num_cubes 6 --timesteps 50000
if %errorlevel% neq 0 (
...
py -3.11 train_rrt_viz_ddqn.py --grid_size 4 --num_cubes 9 --timesteps 50000
if %errorlevel% neq 0 (
...
C:\isaacsim\python.bat train_rrt_isaacsim_ddqn.py --grid_size 3 --num_cubes 4 --timesteps 50000
if %errorlevel% neq 0 (
...
C:\isaacsim\python.bat train_rrt_isaacsim_ddqn.py --grid_size 4 --num_cubes 6 --timesteps 50000
if %errorlevel% neq 0 (
